...
//https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=5028
...
int main()
{
  ...
  while(cin>>N)
  {
    ...
    {
      point ans;
      distToLineSegment(ctr,Q[i-1],Q[i],ans);
      mini=min(mini,dist(ctr,ans));
    }
