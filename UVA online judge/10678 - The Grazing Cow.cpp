...
//https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&category=0&problem=1619&mosmsg=Submission+received+with+ID+
...
int32_t main()
{
    ...
    while(t--)
    {
        ...
        cin>>D>>L;
        db a = L/2;
        db b = sqrt(L/2*L/2-D/2*D/2);
        cout<<fixed<<setprecision(3)<<A_elipse(a,b)<<"\n";
    }
}
